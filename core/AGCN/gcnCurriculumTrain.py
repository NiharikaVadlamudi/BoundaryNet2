'''
- Validation : Change before starting of new-epoch 
- First form a dictionary with all the thresholds 
- Initial Threshold :  HD_thres_{epoch}_class= 0.2 * HD_Enc_Class * self.number
- If sample < H_thresh_epoch_class : Train the loss else skip
- Updating a dictionary of weights , based on loss plateu condition ; across all classes 
'''
...
class Trainer(object):
    def __init__(self, args, opts):
        ...
        self.increment=self.opts['increment']
        self.number=1
    ...
    # def load_hd_encoder(self,hd_weight_file):
    #     # Read JSON file 
    ...
    #     for cls in classes:
    #         self.classwise_hd[cls]={'len':0,'hd':0.0,'hd95':0.0}
    ...
    #         self.instance_dict[key]=hd

    #         if(label in classes ):
    #             self.classwise_hd[label]['len']+=1
    #             self.classwise_hd[label]['hd']+=hd
    #             self.classwise_hd[label]['hd95']+=hd95
    

    #     for key in classes:
    #         self.classwise_hd[key]['hd']/=int(self.classwise_hd[key]['len'])
    #         self.classwise_hd[key]['hd95']/=int(self.classwise_hd[key]['len'])
    #         print('Class : {} , HD Threshold : {}'.format( key,self.classwise_hd[key]['hd']))
    #         print('Class : {} , HD95 Threshold : {}'.format( key,self.classwise_hd[key]['hd95']))
    ...
    def train(self,epoch):
        ...
        if(self.epoch==0):
            self.hd_global_thresh=0.2*self.hd_global_thresh_initial
        ...
        for step, data in enumerate(self.train_loader):
            ...
            try:
                ...
                # hd_thesh=int(self.classwise_hd[class_label]['hd'])*self.gamma*self.number
        ...
        if(self.epoch>=2):
            ...
            if(abs(diff)<3.0):
                self.number+=1
                self.hd_global_thresh+=(self.increment)*self.hd_global_thresh_initial
